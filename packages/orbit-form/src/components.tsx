...
export function useFormStore<TInput extends Record<string, unknown>, TOutput>(): FormStore<
  TInput,
  TOutput
> {
...
export interface FormProps<TInput extends Record<string, unknown>, TOutput> extends Omit<
