...
export default function EditBookmark() {
  ...
  const form = useEditBookmarkForm(
    bookmark
      ? { url: bookmark.url, title: bookmark.title, description: bookmark.description, tags: bookmark.tags.join(", ") }
      : undefined,
  )
  ...
  return (
    <div className="max-w-xl mx-auto p-4">
      ...
      <p className="mt-6 text-sm">
        <Link href={`/bookmarks/${id}`} className="text-gray-500 hover:underline">&larr; Back</Link>
      </p>
    </div>
  )
}
