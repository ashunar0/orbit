...
const posts: Post[] = [
  {
    id: "1",
    title: "Orbit Router リリース",
    body: "ディレクトリベースルーターをリリースしました。",
  },
  {
    id: "2",
    title: "React Compiler 互換の設計",
    body: "useSyncExternalStore ベースでキャッシュ同期する方針に決定。",
  },
  {
    id: "3",
    title: "orbit-query の実装開始",
    body: "SWR の書き心地 + TanStack Query の配列キーを目指します。",
  },
];
